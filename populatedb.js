console.log("This script populates some text books, authors, genres and bookinstances to your database Specified database as argumetn -e.g.: populatedb mongodb://username:password@database_url");

//Get arguments passed on command line

var userArgs = process.argv.slice(2);
if(!userArgs[0].startsWith('mongodb://')){
    console.log("Error: provide correct mongoDB URL as first argument");
    return;
}
...
async.series([
    ...
    if(err){
        ...
        console.log('BookInsances: '+bookinstances);
        console.log("===========",i++);
    }
